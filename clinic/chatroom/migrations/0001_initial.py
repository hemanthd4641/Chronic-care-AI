    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('academic', 'Academic Issue'), ('facility', 'Facility Issue'), ('food', 'Food & Dining'), ('accommodation', 'Accommodation'), ('health', 'Health & Safety'), ('other', 'Other')], max_length=20, null=True)),
